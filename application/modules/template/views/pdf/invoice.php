...
<<<<<<< HEAD
			...
			<div id="notices">
				<div>NOTICE:</div>
				<div class="notice">
					1. The applicants required to provide their own 127mm(1/2 inch)High density PVC piping from the main line to the premises<br/>
					2. The applicant agrees to provide their own water meter secured in a LOCKABLE metal box and cemented to the ground	<br/>
					3. The recommended meter is the sensus metering system model 405s available from Davis and shirtliff ,Dundori road Nairobi<br/>
					4. All due bills must be paid by the 5th day of the following month<br/>
					5. water supply will be disconnected on the 6th day of the month<br/>
					6. The applicant agrees to pay a reconnection fee of shs 500.00<br/>
					7. The applicant agrees to report and repair all water leaks within their property<br/>
					8. The applicant agrees not to install any water sucking devices or pumps which will deprive their neighbors and other consumers water<br/>9. The applicant agrees NOT TO RESELL WATER OR DO IRRIGATION. Penalty will be immediate disconnection and any reconnection will be on a deposit of shs5000.00<br/>
					10. Water mete standing charges : Ksh. <?php echo $standing_charge->amount; ?>/month
				</div>
			</div>
		</main>	
