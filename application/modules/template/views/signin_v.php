...
<head>
  ...
  <title>Enkong'u Water| Log in</title>
  ...
  <!-- iCheck -->
  <link rel="stylesheet" href="<?php echo $this->config->item('assets_url'); ?>plugins/iCheck/square/blue.css">
...
<div class="login-box">
  <div class="login-logo">
    <a href="<?php echo base_url(); ?>"><b>Enkong'u</b>Water</a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    <p class="login-box-msg">Sign in to start your session</p>

    <p class = "text-red"><?php if($this->session->flashdata('error')){ echo $this->session->flashdata('error'); } ?></p>
...
<!-- iCheck -->
<script src="<?php echo $this->config->item('assets_url'); ?>plugins/iCheck/icheck.min.js"></script>
<script>
  $(function () {
    $('input').iCheck({
